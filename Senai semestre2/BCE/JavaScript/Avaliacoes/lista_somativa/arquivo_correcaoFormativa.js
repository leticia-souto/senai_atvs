...
//Testes
verificarEstoque("palete", 11, validacaoEstoque); //pedido negado
verificarEstoque("caixa", 50, validacaoEstoque); //pedido aprovado
verificarEstoque("empilhadeira", 1, validacaoEstoque); //pedido aprovado
...
//     Valor Total:${this.calcularTotal().toFixed(2)}
//     `;
// }
// }
...
//     new GerenteDeLogistica("Lucas", 2500),
// ];
...
// adicionarProduto(qtd){ //set = alterar informacao privada
//     if(qtd != null && qtd > 0){
...
// retirarProduto(qtd){ // set = alterar informacao privada
...
// consultarEstoque(){ // get = exibir informacao privada
