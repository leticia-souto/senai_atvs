...
app.post('/produtos', async (req, res) => {
    try{
        const dados = {id, nome, descricao, preco, categoria} = req.body

        const novoProduto = await queryAsync("INSERT INTO produtos SET dados = ?", [dados])
        ...
        novoProduto = {id, nome, descricao, preco, categoria}
